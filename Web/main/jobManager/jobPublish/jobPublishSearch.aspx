<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jobPublishSearch.aspx.cs" Inherits="main_jobManager_jobPublishSearch" %>
...
<body>
    <form id="form1" runat="server">
        <div id="man_zone">
            ...
            <asp:GridView ID="gvJobList" runat="server" CssClass="GridView" Width="99%" align="center" AutoGenerateColumns="False" DataSourceID="odsJob" OnRowDataBound="gvJobList_RowDataBound">
                <Columns>
